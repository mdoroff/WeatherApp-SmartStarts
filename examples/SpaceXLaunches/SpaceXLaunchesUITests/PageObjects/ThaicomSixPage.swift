...
public class ThaicomSixPage: BaseTest {
    ...
    lazy var strCCAFSSLC40 = app.staticTexts["CCAFS SLC 40"]
    lazy var strLaunchDate = app.staticTexts["Launch date:"]
    lazy var strJan6 = app.staticTexts["1/6/14"]
